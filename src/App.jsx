function App() {
  return (
    <div className="min-h-screen w-full bg-slate-950 text-white relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(1200px_600px_at_10%_-10%,rgba(56,189,248,0.25),transparent),radial-gradient(1000px_500px_at_110%_10%,rgba(168,85,247,0.18),transparent)]" />
        ...
        <div className="mx-auto max-w-7xl px-6 pt-10 pb-16">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <a href="#support" className="inline-flex items-center justify-center rounded-2xl bg-blue-500 hover:bg-blue-400 active:bg-blue-600 transition text-white px-5 py-3 text-sm font-medium shadow-lg shadow-blue-500/30">Get Support</a>
              <a href="mailto:playbasestudioss@gmail.com" className="inline-flex items-center justify-center rounded-2xl bg-white/10 hover:bg-white/15 active:bg-white/20 transition text-white px-5 py-3 text-sm font-medium border border-white/10 backdrop-blur">Email Us</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-8 backdrop-blur">
            ...
            <ul className="mt-4 space-y-3 text-slate-300/90">
              ...
              <li className="flex items-start gap-3"><span className="mt-1 text-blue-300">•</span><span>Simple steps to get you unblocked fast.</span></li>
            </ul>
          </div>
